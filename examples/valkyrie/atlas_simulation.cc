...
#include "drake/examples/valkyrie/atlas_constants.h"
#include "drake/examples/valkyrie/atlas_simulator.h"
...
int main() {
  ...
  // LCM communication.
  lcm::DrakeLcm lcm;
  AtlasSimulationDiagram diagram(&lcm, FLAGS_dt);
  ...
  VectorX<double> initial_state = RPYAtlasFixedPointState();
