...
class AtlasSimulationDiagram : public systems::Diagram<double> {
 public:
  AtlasSimulationDiagram(lcm::DrakeLcm* lcm, double dt) {
    ...
    std::vector<RigidBodyFrame<double>> force_torque_sensor_info = {
        RigidBodyFrame<double>("leftFootFTSensor", tree.FindBody("l_foot"),
                               Isometry3<double>::Identity()),
        RigidBodyFrame<double>("rightFootFTSensor", tree.FindBody("r_foot"),
                               Isometry3<double>::Identity())};
